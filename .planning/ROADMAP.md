...
- [x] 01-04-PLAN.md — The governed sentences, the duplicate-literal check and the claims audit (wave 2)
...
- [x] 01-08-PLAN.md — The deployment probe, the toolchain closures and README (wave 6)
...
- [x] 02-05-PLAN.md — observations.ts and the resolver / comment-fidelity check with its failing fixtures (wave 4)
...
- [x] 03-01-PLAN.md — lib/limits, the one signing key, not_open and the retained segment fields, the refusal sentences, and the unit-suite gate step (wave 1)
...
- [x] 03-06-PLAN.md — The fixture-inputs rule and the named-package ban wired into verify (wave 3)
...
- [x] 03-11-PLAN.md — The walk payload and the walk route (wave 4)
